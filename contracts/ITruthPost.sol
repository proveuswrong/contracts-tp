...
abstract contract ITruthPost {
    ...
    */
    function getRoundInfo(uint256 _disputeID, uint256 _round) external view virtual
    returns (
    ...
    */
    function getAmountRemainsToBeRaised(uint256 _disputeID, RulingOptions _ruling) external view virtual returns (uint256);
    ...
    */
    function getReturnOfInvestmentRatio(RulingOptions _ruling, RulingOptions _lastRoundWinner) external view virtual returns (uint256);
